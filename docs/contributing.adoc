...
= Contributing — veridical-simulation-core
:revdate: 2026-MM-DD

== Audience

Developers working *on* `veridical-simulation-core`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/veridical-simulation-core.git
cd veridical-simulation-core
...
* Bugs in `veridical-simulation-core`: file at `hyperpolymath/veridical-simulation-core/issues`.
