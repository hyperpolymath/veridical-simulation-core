...
= Troubleshooting — veridical-simulation-core
:revdate: 2026-MM-DD
...
* `https://github.com/hyperpolymath/veridical-simulation-core/issues?q=is%3Aissue+<your symptom>` — has anyone hit this before?
